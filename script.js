...
function loadLanguage(lang) {
  if (lang === 'en') {
    ...
    updateText({
      ...
      hero_h1: "Professional Gardening in Scotland",
      hero_p: "I help your garden thrive – lawn care, pruning, design & more.",
      hero_btn: "Get a Quote",
      services_h2: "My Services",
      service_1: "Lawn Mowing & Edging", service_2: "Fence Painting",
      service_3: "Hedge Cutting", service_4: "Weed Control",
      about_h2: "About JR Garden Help",
      about_p: "Run by Jonathan Rainey since 2025. Based in Dumbarton, serving Dumbarton, West Dunbartonshire and Neighbouring Counties.",
